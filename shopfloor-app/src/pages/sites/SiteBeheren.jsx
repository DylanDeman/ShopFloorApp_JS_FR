  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setVerantwoordelijken(
          Array.isArray(verantwoordelijkenData.items) 
            ? verantwoordelijkenData.items 
            : (Array.isArray(verantwoordelijkenData) ? verantwoordelijkenData : [])
        );
